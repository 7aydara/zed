        ...
        for line in res.iter_lines():
            ...
            if line:
                ...
                if text:
                    ...
                    if len(sentences) > 1:
                        # Yield all complete sentences, keep the last (possibly incomplete)
                        for sentence in sentences[:-1]:
                            full_response.append(sentence)
                            yield sentence
                        buffer = sentences[-1]
                    # If only one "sentence" and buffer ends with sentence-ender,
                    # it's complete
...
def _analyze_memory(user_text: str, response_text: str) -> None:
    ...
    try:
        ...
        for n in nodes:
            ...
            valid_categories = ["00_Core", "10_People", "20_Projects", "30_Concepts", "90_Journal"]
            ...
            if not node_file.exists():
                ...
                node_file.write_text(header + entry, encoding="utf-8")
                ...
                merge_prompt = (
                    ...
                    "Do not just append it. Return ONLY the merged markdown text. Do not include extra conversational text."
                )
                merge_payload = {
                    "model": config.OLLAMA_MODEL,
